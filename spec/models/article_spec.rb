...
RSpec.describe Article, type: :model do
  ...
  subject do
    Article.new(title: "Hello World",content:"Instead of finding the text Name can't be blank on the page, it found the text City was successfully created.. Evidently, Rails happily accepted our blank Name input and created a city with an empty string for a name.",
    image_id:image.id,
    user_id:user.id,
